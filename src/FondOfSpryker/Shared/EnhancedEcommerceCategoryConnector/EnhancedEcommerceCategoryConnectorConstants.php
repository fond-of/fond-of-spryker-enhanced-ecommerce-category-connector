...
namespace FondOfSpryker\Shared\EnhancedEcommerceCategoryConnector;

interface EnhancedEcommerceCategoryConnectorConstants
{
    ...
    public const PARAM_PRODUCT_ATTR = 'attributes';
